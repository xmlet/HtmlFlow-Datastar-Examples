...
1. `npm install --legacy-peer-deps` (installs the node modules and the TypeScript definition files)
2. `$env:PORT="4444"; npm start` (Windows PowerShell) or `PORT=4444 npm start` (Linux/Mac) 
